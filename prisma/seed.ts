...
const SHIFT_TYPES = [
  ...
  { code: 'SH',  name: 'Halb Spätdienst',              startTime1: '16:00', endTime1: '21:10', durationMinutes: 310, bgColor: '#FEE2E2', textColor: '#991B1B', borderColor: '#FCA5A5', color: '#DC2626', isAbsence: false, sortOrder: 12, eligibleRoles: '["TEAMLEITUNG","FUNKTIONSSTUFE_3","FUNKTIONSSTUFE_2","FUNKTIONSSTUFE_1","LERNENDE"]' },
  // Absences
