      ...
      <div style={{ padding: '20px 28px' }}>
        ...
        <div style={{ background: 'white', border: '1px solid #D8E2E8', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', background: '#001E30' }}>
            {WEEKDAYS.map(d => (
              <div key={d} style={{ padding: '8px 0', textAlign: 'center', fontSize: '0.62rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.6)', fontFamily: "'Syne', sans-serif", fontWeight: 600 }}>
                {d}
              </div>
            ))}
          </div>
