...
const STATUS_LABELS: Record<string, { pt: string; de: string }> = {
  DRAFT:     { pt: 'Rascunho',   de: 'Entwurf'          },
  GENERATED: { pt: 'Gerado',     de: 'Generiert'        },
  PUBLISHED: { pt: 'Publicado',  de: 'Veröffentlicht'   },
  LOCKED:    { pt: 'Bloqueado',  de: 'Gesperrt'         },
}
    ...
    <>
      ...
      >
        ...
        <span style={{ fontSize: '0.72rem', fontWeight: 600, padding: '3px 10px', borderRadius: 20, background: statusStyle.bg, color: statusStyle.color, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          {(STATUS_LABELS[scheduleStatus]?.[lang] ?? scheduleStatus)}
        </span>
